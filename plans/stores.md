...
3. Neue Events werden in Batches gespeichert (Transaktionen).
4. Materialisierte Tabellen (`thread_heads`, `reactions`) werden inkrementell aktualisiert.
5. `liveQuery` triggert nur betroffene Komponenten.
